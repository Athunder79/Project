...
addEventListener('load', function () {
    ...
    document.getElementById("shot").addEventListener("click", checkInputShot);
    document.getElementById("finishhole").addEventListener("click", checkFinishHole);
...
function checkInputHole() {
    ...
    if (holeLengthInput === "" || holeParInput === "a") {
        alert("Please enter the hole length and par");
    } else {
        submitDetails()
    }
}
...
function checkInputShot() {
    ...
    if (clubInput === "Select Club" || distanceInput === "") {
        alert("Please select a club and enter the distance before adding the shot.");
    } else {
        addShot()
    }
}
